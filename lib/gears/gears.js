 ...
 *  application or else ... boom
 */
let pattern

export class Gears {
  static pattern = (p) => (
    p ? (pattern = p) : pattern // return if p is truthy true then assign pattern value of p else pattern
  )

  static engage = (s, o = {}) => (
    s ? engage(s, o) : !!0 // return is s is truthy true then engage else false
  )
